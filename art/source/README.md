...
- `biome-mushroom-kingdom-*`: a bright classic-platformer kingdom with rounded hills, pipes, bricks, mushrooms, castle roads, grassy soil, a pipe/turret landmark, safe brick-and-grass platforms, pipe gates, carnivorous plant thorns, and armored shell barbs.
...
- `transition-*-v2.png`: eight safe threshold landmarks that physically blend adjacent chapter materials from Underground Jungle through Underworld.
- `biome-*-{midground,near}-v2.png`: transparent authored parallax plates for all ten biomes. Midground plates use receding biome structures and landmarks; near plates use roots, pipes, stone, timber, rails, chains, or fortress fragments around an open gameplay center. The fourteen plates added across seven biomes on 2026-08-20 were generated as precise-object edits of their matching panorama references, with neutral preview checkerboards removed where ImageGen baked them into otherwise opaque outputs.
