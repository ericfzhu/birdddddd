...
export const CHUNKS: readonly ChunkDefinition[] = [
  ...
  chunk("nursery-rungs", 0, 240, [ceilingBarbs(54, 24, 21), floorBarbs(138, 28, 21)], featherArc([[72, 112], [108, 90], [154, 68]])),
  ...
  chunk("midnight-nests", 3, 270, [floorBarbs(54, 26), ceilingBarbs(214, 28)], featherArc([[90, 64], [142, 92], [204, 116]]), [perch(96, 116, 38), perch(156, 58, 38)], ANY, ANY, "nest"),
  ...
  chunk("midnight-belfry", 3, 270, [ceilingBarbs(52, 22), spinner(122, 78, 20, { amplitude: 30, frequency: 0.3 }), floorBarbs(214, 24)], featherArc([[72, 112], [158, 88], [228, 62]]), [], ANY, ANY, "bells"),
  chunk("midnight-finale", 3, 280, [floorBarbs(46, 22, 23), ceilingBarbs(102, 22, 23), floorBarbs(160, 22, 23), ceilingBarbs(218, 22, 23)], featherArc([[64, 60], [120, 120], [178, 60], [236, 120]]), [], ANY, ANY, "eggs"),
] as const;
